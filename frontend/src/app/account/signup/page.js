            ...
            <div className="relative min-h-screen flex ">
                <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
                    <div className="sm:w-1/2 md:w-2/6 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
                        style={{ backgroundImage: "url(/static/images/account-bg-image.avif)" }}>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6" action="#" method="POST">
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        type="" placeholder="mail@gmail.com" defaultValue="mail@gmail.com" {...register("email", {required: true, maxLength:60})} />
                                </div>
                                <div className="mt-8 content-center">
                                    ...
                                    <input
                                        ...
                                        type="" placeholder="Enter your password" defaultValue="*****|"  {...register("password", {required: true, maxLength:200})} />
                                </div>
                                <div className="mt-8 content-center">
                                    <label className="ml-3 text-sm font-bold text-gray-700 tracking-wide">
                                        Confirm Password
                                    ...
                                    <input
                                        className="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500"
                                        type="" placeholder="Enter your password" defaultValue="*****|"  {...register("confirmPassword", {required: true, maxLength:200})} />
                                </div>
